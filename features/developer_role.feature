...
#    Then the response status code should be 403
  ...
  Scenario: Permissions configuration for the developer.
    Given I am logged in as a user with the "developer" role
    Then I should not have the "administer modules, administer software updates, administer themes, administer users, use workbench tabs" permissions